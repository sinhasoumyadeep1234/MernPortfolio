...
const projects=[
  {
    ...
    title:'Project 1 : E-commerce Application',
    description:'An ecommerce application',
    fullDescription:'An E-commerce application made using react and spring framework, where users can place orders, add products, view cart, view order by id and many more',
    video:'https://drive.google.com/file/d/1rxuhYmZIGea96CXsWCT-VH75uzOAUcm-/preview',
    ...
    fullDescription:'An employee management system made using react and spring framework, where one can manage employees',
    video:'https://drive.google.com/file/d/1bu7jT8Xgtp6Z8piz_0pagpxkwditfm9R/preview',
    link: 'Currently not hosted'
  },
   {
    id:3,
    image:'/assets/images/linkCanopy.png',
    title:'Project 3 : LinkCanopy',
    description:'A LinkTree Clone',
    fullDescription:'A modern Linktree-inspired app built with Next.js 15, allowing users to create and customize their personal link-in-bio pages with dynamic content, sleek design, and optimized performance',
    video:'https://drive.google.com/file/d/1nI9BCAqVexgI-rNH1tv7AGfbmVMmSaSm/preview',
    link: 'https://link-canopy-9lfp.vercel.app/'
  },
   {
    id:4,
    image:'/assets/images/url.png',
    title:'Project 4 : Shortify - The URL Shortener',
    description:'An URL Shortner App',
    fullDescription:'An URL Shortner App that can be used to shorten existing url, without any login/signup required made using Next.js and mongodb',
    video:'https://drive.google.com/file/d/1VCbOrj4KQ_Vu9sAalme2AtGlv37GEPyS/preview',
    link: 'https://shortify-ecru.vercel.app/'
  },
  {
    id:5,
    image:'/assets/images/amazon1.png',
    title:'Project 5 : AMAZON',
  ...
  },
  {
    ...
    title:'Project 11 : TEXT UTILITY APP',
  ...
  },
  {
    ...
    link: 'Currently link is down for maintenance'
  },
  {
    id:13,
    image:'/assets/images/chatbot.png',
    title:'Project 13 : AI-BASED CHATBOT',
  ...
  },
  {
    ...
    title:'Project 14 : Animated Landing Page',
